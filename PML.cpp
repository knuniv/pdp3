...
PML::PML(double comp_l_1, double comp_l_2, double sigma1_t, double sigma2_t)
{
	comparative_l_1 = comp_l_1; // lenhgt sigma in r direction
	comparative_l_2 = comp_l_2; // lenght sigma in z direction
	sigma1 = sigma1_t;
	sigma2 = sigma2_t;
...
//////////////////////////////////////////
  ...
  // defining lenght of sigma calculation in z direction//
	double lenght_sigma_z =geom1->dz * (floor(geom1->n_grid_2*comparative_l_1));

	// defining lenght of sigma calculation in r direction//
	double lenght_sigma_r =geom1->dr * (floor(geom1->n_grid_1*comparative_l_2));
/////////////////////////////////////////////////////////////////////////////////
	//if pml is only z walll//
	if (comparative_l_1==0.0)
	{
...
if((comparative_l_2==0)||(comparative_l_1==0))
{
}
else
{
