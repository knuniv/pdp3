...
int main() 
{
	...
	Geometry geom1(16,32, 17, 33, &pml1);
	Time time1(0,0, 100000e-10,1e-10);
...
//	e_field1.set_sigma();
	...
	new_particles.x1[0] = 4.0001;
    new_particles.x3[0] = 12.0001;
	new_particles.v1[0] = 1e8;
	new_particles.v2[0] = 0;
	new_particles.v3[0] = 1e8;
