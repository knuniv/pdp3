...
//	e_field1.set_sigma();
	...
	///////////////////////////////////////////
	// beam part
	Bunch electron_bunch("electron_beam", -1, 1, 6e5, &geom1,&p_list,0.01);
	electron_bunch.calc_init_param(&time1,100,5e12,3e7);
	///////////////////////////////////////////
...
//electron_beam.beam_inject(1e14,5e7,&time1);
		electron_bunch.bunch_inject(&time1,100,1.6e8,0.5);
		//radiation  source
